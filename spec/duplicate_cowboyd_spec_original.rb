...
#       t.call(name: ->(_context) {; 'Mate' }).should eql 'Hello Mate'
#     end
...
#     before do
#       subject.register_helper('alsowith') do |_this, context, block|
#         block.fn(context)
#       end
#       subject.register_helper(:twice) do |_this, block|
#         "#{block.fn}#{block.fn}"
#       end
#     end
...
#       subject.partial_missing do |name|
#         lambda do |_this, context, _options|
...
#       t.call(safe: ->(_this, *_args) { Handlebars::SafeString.new('<pre>totally safe</pre>') }).should eql '<pre>totally safe</pre>'
#     end
#   end
...
#     before do
#       subject.register_helper('list') do |_this, context, block|
...
#     before do
#       subject.register_helper :list do |_this, context, options|
